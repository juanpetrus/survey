...
class OptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post options_url, params: { option: { option_description: @option.option_description, poll_id: @option.poll_id, qty: @option.qty } }, as: :json
    end
  ...
  test "should update option" do
    patch option_url(@option), params: { option: { option_description: @option.option_description, poll_id: @option.poll_id, qty: @option.qty } }, as: :json
    assert_response 200
  end
